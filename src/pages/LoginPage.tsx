  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    if (success) {
      toast({
        ...
        description: "Welcome to Desi Grocery Ireland.",
      });
      navigate(redirect);
    } else {
      toast({
      ...
      <div className="container py-12">
        ...
        >
          <div className="text-center mb-8">
            <div className="w-16 h-16 rounded-full gradient-saffron flex items-center justify-center mx-auto mb-4 text-3xl">
              🛒
            </div>
            <h1 className="text-2xl font-bold text-foreground">Welcome to Desi Grocery</h1>
